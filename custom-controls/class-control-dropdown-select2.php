	...
	class Skyrocket_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				CUSTOMIZER_DIR_ASSETS  . '/assets/js/control-dropdown-select2.js',
				array( 'skyrocket-select2-js', 'pages-controls-js' ),
				'1.0',
				true
			);
			wp_enqueue_style( 'skyrocket-control-dropdown-select2-css', CUSTOMIZER_DIR_ASSETS . '/assets/css/control-dropdown-select2.css', array(), '1.1', 'all' );
