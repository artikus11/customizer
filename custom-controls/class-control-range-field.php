	...
	class Skyrocket_Range_Custom_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				get_stylesheet_directory_uri() . '/includes/customizer/assets/js/control-slider-field.js',
				array(
					'jquery',
					'jquery-ui-core',
				),
			...
			wp_enqueue_style( 'skyrocket-control-slider-field-css', get_stylesheet_directory_uri() . '/includes/customizer/assets/css/control-slider-field.css', array(), '1.0', 'all' );
		}
